...
export declare interface AddTeamsParticipantOptions {
    /**
     * Thread id is optional for Teams group call.
     */
    threadId?: string;
...
export declare interface CallAgent extends CallAgentCommon {
    ...
    /**
     * Subscribe function for handleIncomingCall event.
     * @param event - event name.
     * @param listener - callback fn that will be called when this callAgent finishs handling incoming call notification.
     */
    ...
    /**
     * Unsubscribe function for handleIncomingCall event.
     * @param event - event name.
...
export declare interface CallCommon extends Disposable {
    ...
    /**
     * Subscribe function for caller info changed event.
     * @param event
     * @param listener
     */
    on(event: 'callerInfoChanged', listener: PropertyChangedEvent): void;
    /**
     * Subscribe function for caller info changed event.
     * @param event
     * @param listener
     */
    on(event: 'transferorInfoChanged', listener: PropertyChangedEvent): void;
    /**
    ...
    /**
     * Unsubscribe function for caller info changed event.
     * @param event
     * @param listener
     */
    off(event: 'callerInfoChanged', listener: PropertyChangedEvent): void;
    /**
     * Unsubscribe function for caller info changed event.
     * @param event
     * @param listener
     */
    off(event: 'transferorInfoChanged', listener: PropertyChangedEvent): void;
}
...
export declare interface DeviceManager {
     ...
     * @param permissionConstraints - Configure which permission (audio/video) to request.
     ...
     * @param parameters - Configures which devices (audio/video) to preheat.
     */
    startPreheatDevices(parameters: StartPreheatDeviceParameters): Promise<void>;
    /**
     * Stop preheating devices.
     * @param parameters - Configures which devices (audio/video) to stop preheating.
     */
    stopPreheatDevices(parameters: StopPreheatDeviceParameters): void;
    /**
...
/**
 * Reason why participant display name changed.
 */
export declare type DisplayNameChangedReason = 'editedDisplayName';
...
export declare const Features: {
    ...
    RealTimeText: CallFeatureFactory<RealTimeTextFeature>;
};
...
/**
 * Payload for handleIncomingCall event
 */
export declare type HandleIncomingCallEvent = (args: {
    callId: string;
    participantId: string;
} & CallEndReason) => void;
 ...
 * Pass audio options whether to join the call muted or unmuted.
...
export declare interface MediaAccessCallFeature extends CallFeature {
    /**
     * Allows specified participants with role attendee to unmute
     * @param participants - A list of participants for whom to enable audio. This parameter is required and cannot be an empty array or contain undefined or null values.
     */
    permitAudio(participants: CommunicationIdentifier[]): Promise<void>;
    /**
     * Deny specified participants with role attendee to unmute
     * @param participants - A list of participants for whom to disable audio. This parameter is required and cannot be an empty array or contain undefined or null values.
     */
    forbidAudio(participants: CommunicationIdentifier[]): Promise<void>;
    /**
     * Send request to allow all attendees to unmute
     */
    permitOthersAudio(): Promise<void>;
    /**
     * Send request to deny all attendees to unmute
     */
    forbidOthersAudio(): Promise<void>;
    /**
     * Allows specified participants with role attendee to turn video on
     * @param participants - A list of participants for whom to enable video. This parameter is required and cannot be an empty array or contain undefined or null values.
     */
    permitVideo(participants: CommunicationIdentifier[]): Promise<void>;
    /**
     * Deny specified participants with role attendee to turn video on
     * @param participants - A list of participants for whom to disable video. This parameter is required and cannot be an empty array or contain undefined or null values.
     */
    forbidVideo(participants: CommunicationIdentifier[]): Promise<void>;
    /**
     * Send request to allow all attendees to turn video on
     */
    permitOthersVideo(): Promise<void>;
    /**
     * Send request to deny all attendees to turn video on
     */
    forbidOthersVideo(): Promise<void>;
    /**
     * Get the media access for all remote participants
     */
...
export declare interface OnBehalfOfOptions {
     ...
     */
    userId: MicrosoftTeamsUserIdentifier | MicrosoftTeamsAppIdentifier;
}
...
'forbidOthersVideo' | 
/**
* Ability to send real time text messages in calling type calls
*/
'realTimeText';
...
export declare interface ParticipantInfo {
    ...
    readonly displayName?: string;
    /**
     * Optional if display name has changed by the endpoint of that remote participant.
     */
    readonly hasDisplayNameChanged?: boolean;
    /**
 ...
 * Participant role.
 */
export declare type ParticipantRole = 'Unknown' | 'Attendee' | 'Presenter' | 'Organizer' | 'Co-organizer' | 'Consumer' | 'Collaborator';
...
/**
 * Payload for property changed event with arguments.
 */
export declare type PropertyChangedEventWithArgs<TValue, TReason> = (args: {
    newValue?: TValue;
    oldValue?: TValue;
    reason?: TReason;
}) => void;
...
/**
 * Data structure for RealTimeText object
 */
export declare interface RealTimeTextFeature extends CallFeature {
    /**
     * Send RealTimeText, if finalized is not provided message will be partial
     */
    sendRealTimeText(text: string): Promise<void>;
    /**
     * Send RealTimeText with finality indicating if the message is finalized or partial
     */
    sendRealTimeText(text: string, finalized: boolean): Promise<void>;
    /**
     * Subscribe function for any of the RealTimeTextReceivedEventType events
     * @param event - event name
     * @param listener - callback fn that was used to subscribe to this event
     */
    on(event: RealTimeTextReceivedEventType, listener: RealTimeTextReceivedEventHandler): void;
    /**
     * Unsubscribe function for any of the RealTimeTextReceivedEventType events
     * @param event - event name
     * @param listener - callback fn that was used to subscribe to this event
     */
    off(event: RealTimeTextReceivedEventType, listener: RealTimeTextReceivedEventHandler): void;
}

/**
 * Data structure received for each RealTimeText event.
 */
...
/**
 * Callback definition for handling the RealTimeTextReceivedEventType event
 */
export declare type RealTimeTextReceivedEventHandler = (data: RealTimeTextInfo) => void;

/**
 * Event type for RealTimeText Received event
 */
export declare type RealTimeTextReceivedEventType = 'realTimeTextReceived';

/**
 * Type for classifying the finality of the current message.
 *
 * RealTimeTextInfo will have ResultType of Partial if the text contains partially completed message.
 * RealTimeTextInfo will have ResultType of Final if the text ends with a new line character or lock timer expired.
 */
export declare type RealTimeTextResultType = 'Partial' | 'Final';
...
export declare interface RemoteParticipant extends ParticipantInfo {
    ...
    readonly role: ParticipantRole;
    /**
     * Mute microphone of this remote participant. Not supported in 1-to-1 calls.
     */
    mute(): Promise<void>;
     ...
     * @param listener - callback fn that will be called when value of this property will change.
     */
    on(event: 'displayNameChanged', listener: PropertyChangedEvent | PropertyChangedEventWithArgs<string, DisplayNameChangedReason>): void;
    /**
     * Subscribe function for roleChanged event.
     * @param event - event name.
     * @param listener - callback fn that will be called when value of this property will change.
     ...
     * @param listener - callback fn that was used to subscribe to this event.
     */
    off(event: 'displayNameChanged', listener: PropertyChangedEvent | PropertyChangedEventWithArgs<string, DisplayNameChangedReason>): void;
    /**
     * Unsubscribe function for roleChanged event.
     * @param event - event name.
     * @param listener - callback fn that was used to subscribe to this event.
...
/**
 * Start preheat device parameters.
 */
export declare interface StartPreheatDeviceParameters {
    audio?: {
        /**
         * Whether to start preheating audio devices or not.
         */
        preheat: boolean;
        /**
         * Timeout in seconds for preheating audio devices.
         * If the timeout is reached, the preheat will be stopped.
         */
        timeoutInSec?: number;
    };
    video?: {
        /**
         * Whether to start preheating video devices or not.
         */
        preheat: boolean;
        /**
         * Timeout in seconds for preheating video devices.
         * If the timeout is reached, the preheat will be stopped.
         */
        timeoutInSec?: number;
    };
...
/**
 * Stop preheat device parameters.
 */
export declare interface StopPreheatDeviceParameters {
    /**
     * Whether to stop preheating audio devices or not.
     */
    audio?: boolean;
    /**
     * Whether to stop preheating video devices or not.
     */
    video?: boolean;
}
...
export declare interface TeamsCall extends CallCommon {
     ...
     */
    addParticipant(participant: MicrosoftTeamsUserIdentifier | PhoneNumberIdentifier | MicrosoftTeamsAppIdentifier | UnknownIdentifier, options?: AddTeamsParticipantOptions): RemoteParticipant;
    /**
     * Remove a participant from this call.
...
export declare interface TeamsCallAgent extends CallAgentCommon {
     ...
     * @returns The TeamsCall object associated with the call.
     */
    startCall(participants: (MicrosoftTeamsUserIdentifier | PhoneNumberIdentifier | MicrosoftTeamsAppIdentifier | UnknownIdentifier)[], options?: StartTeamsGroupCallOptions): TeamsCall;
    /**
     * Join a Teams meeting.
     * To join a Teams meeting, pass a meeting link.
     * @param meetingLocator - Meeting information.
